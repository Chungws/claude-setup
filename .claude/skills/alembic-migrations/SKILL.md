...
description: Database migration management for Dudaji Dashboard using Alembic. Use when creating/applying migrations after model changes. Critical rule - ALWAYS use --autogenerate, NEVER edit migration files manually (except data migrations).
---
