...
description: shadcn/ui component usage for Dudaji Dashboard. Use when building UI. Critical rules - ALWAYS use shadcn/ui components (NOT raw HTML), npx shadcn@latest add to install components, NEVER edit components/ui/ directly.
---
