...
description: Test-Driven Development workflow for Dudaji Dashboard backend. Use when implementing backend features, writing tests, or following TDD practices. Covers Red-Green-Refactor cycle, AAA pattern, and pytest usage.
---
