...
description: FastAPI architecture patterns for Dudaji Dashboard. Use when building backend features. Critical rules - 4-layer structure (models → schemas → service → router), business logic in service layer, thin routers, async/await for all DB calls.
---
