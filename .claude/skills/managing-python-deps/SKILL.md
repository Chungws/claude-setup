...
description: Python dependency management for Dudaji Dashboard using uv (NOT pip). Use when adding/removing packages, running commands, or managing dependencies. Critical rule - NEVER use pip install or edit pyproject.toml directly.
---
...
cd /path/to/mujoco-web  # Navigate to root first
